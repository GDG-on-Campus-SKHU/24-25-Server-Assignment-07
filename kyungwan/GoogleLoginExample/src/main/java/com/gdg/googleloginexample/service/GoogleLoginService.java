...
import com.gdg.googleloginexample.dto.UserInfo;
...
public class GoogleLoginService {
    ...
    @Autowired
    public GoogleLoginService(@Value("${google.client_id}") String GOOGLE_CLIENT_ID, @Value("${google.client_secret") String GOOGLE_CLIENT_SECRET,
